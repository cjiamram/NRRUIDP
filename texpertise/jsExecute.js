...
function displayData(){
		var url="texpertise/displayData.php?tableName=t_expertise&dbName=dbimprovement&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
...
function readOne(id){
		var url='texpertise/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="texpertise/delete.php?id="+id;
