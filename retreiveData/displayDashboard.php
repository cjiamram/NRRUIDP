...
<div class="row">
         <div class="col-sm-6" id="dvDepartment">
...
<div class="row">
<iframe id="dvPivot" style="width:100%;height:400px"></iframe>
</div>
...
<script>
  ...
  function setPieDepartment(){
      var url="<?=$rootPath?>/retreiveData/pieDepartment.php?sYear="+$("#obj_sYear").val()+"&fYear="+$("#obj_fYear").val()+"&depArr="+$("#depArr").val();
      $("#dvDepartment").load(url);
  }

  function setPiePType(){
     var url="<?=$rootPath?>/retreiveData/piePType.php?sYear="+$("#obj_sYear").val()+"&fYear="+$("#obj_fYear").val()+"&depArr="+$("#depArr").val();
     $("#dvPType").load(url);
  } 


  function setPivot(){
      var url="<?=$rootPath?>/retreiveData/pivotData.php?sYear="+$("#obj_sYear").val()+"&fYear="+$("#obj_fYear").val()+"&depArr="+$("#depArr").val();
