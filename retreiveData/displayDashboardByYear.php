          ...
          <div class="box-header with-border">
           ...
           <div class="modal-body" id="dvFilter">
            ...
            <?php
                ...
                echo "<tr><td colspan='2'><input type='checkbox' id='chkAll' checked>ทั้งหมด</td></tr>\n";
...
<script>
  ...
  function setPieDepartmentByYear(year){
     var url="<?=$rootPath?>/retreiveData/pieCountDepartmentbyYear.php?Year="+year;
     $("#dvDepartment").load(url);
  } 

  function setPiePTypeByYear(year){
     var url="<?=$rootPath?>/retreiveData/pieCountPTypeByYear.php?Year="+year;
     //console.log(url);
     $("#dvPType").load(url);
  } 
