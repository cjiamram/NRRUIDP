...
function displayData(){
		var url="trequesttype/displayData.php?tableName=t_requesttype&dbName=dbimprovement&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='trequesttype/create.php';
		jsonObj={
			code:$("#obj_code").val(),
...
function updateData(){
		var url='trequesttype/update.php';
		jsonObj={
			code:$("#obj_code").val(),
			requestType:$("#obj_requestType").val(),
			id:$("#obj_id").val()
...
function readOne(id){
		var url='trequesttype/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
...
function confirmDelete(id){
		...
		if (willDelete.value) {
			url="trequesttype/delete.php?id="+id;
