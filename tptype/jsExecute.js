...
function displayData(){
		var url="tptype/displayData.php?tableName=t_ptype&dbName=dbimprovement&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tptype/create.php';
		jsonObj={
			code:$("#obj_code").val(),
			pType:$("#obj_pType").val()
		}
...
function readOne(id){
		var url='tptype/readOne.php?id='+id;
		data=queryData(url);
		if(data!=""){
