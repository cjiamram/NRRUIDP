...
<section class="content-header">
     <h1>
        ...
        <small>>><?=$objLbl->getLabel("t_supervisor","input","th")?></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
      ...
      <h3 class="box-title"><b><?=$objLbl->getLabel("t_supervisor","input","th")?></b></h3>
      </div>
     ...
     <div class="modal-dialog" id="dvInput" >
      <div class="modal-content">
          <div class="box-header with-border">
                ...
                <h4 class="modal-title"><?=$objLbl->getLabel("t_supervisor","input","th")?></h4>
           </div>
