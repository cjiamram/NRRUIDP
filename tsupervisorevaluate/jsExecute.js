...
function displayData(){
		var url="tsupervisorevaluate/displayData.php?tableName=t_supervisorevaluate&dbName=dbimprovement&keyWord="+$("#txtSearch").val();
		$("#tblDisplay").load(url);
}
function createData(){
		var url='tsupervisorevaluate/create.php';
		jsonObj={
...
function updateData(){
		var url='tsupervisorevaluate/update.php';
		jsonObj={
			userCode:$("#obj_userCode").val(),
			departmentCode:$("#obj_departmentCode").val(),
			evaluateLevel:$("#obj_evaluateLevel").val(),
